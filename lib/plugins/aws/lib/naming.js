...
module.exports = {
  ...
  // CloudFront
  getCloudFrontDistributionLogicalId(distributionObj) {
    return `CloudFrontDistribution${distributionObj.name || ''}`;
  },
  getCloudFrontDistributionDomainNameLogicalId(distributionObj) {
    return `CloudFrontDistributionDomainName${distributionObj.name || ''}`;
  },
